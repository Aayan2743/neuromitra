        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Therapist</li>
                </ul>
            </div>
        ...
        <div class="main-content">
            <div class="row">
                ...
                <div class="col-xxl-12">
                    <div class="card stretch stretch-full">
                        <div class="card-header">
                            <h5 class="card-title">Add Therapist</h5>
                ...
                <div class="col-xxl-12">
                    <div class="card stretch stretch-full">
                        <div class="card-header">
                            <h5 class="card-title">List Of Therapist</h5>
                            <div class="card-header-action">
                                <div class="card-header-btn">
                                            ...
                                            <td>
                                                ...
                                                <div class="action-buttons">
                                                    ...
                                                    <form action="{{ route('therapists.destroy', $therapist->id) }}" method="POST" style="display:inline;">
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger btn-sm"
                                                        onclick="confirmDelete({{ $therapist->id }})">
                                                            Delete
                                                        </button>
                                                    </form> --}}
                                                </div>   
...
<script>
   ...
   // Define the confirmDelete function
    ...
    //                     location.reload();
    //                 });
    //                     // Optionally, remove the therapist row from the UI
    //                     // document.getElementById('therapist-row-' + id).remove();
    //                 } else {
    //                     Swal.fire(
    //                         'Error!',
    //                         'Something went wrong.',
