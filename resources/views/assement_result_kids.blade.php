        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">List Of Kids Assements </li>
                </ul>
            </div>
                                ...
                                <table class="table table-hover mb-0">
                                    <thead>
                                        <tr class="border-b">
                                            ...
                                            <th scope="row">Childern Name</th>
                                            <th scope="row">Childern Age</th>
                                            <th scope="row">Childern Gender</th>
                                    ...
                                    @forelse ($listofanswers as $key=> $therapist)
                                       ...
                                       @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$data['child_info']['name']}}</td>
                                            <td>{{$data['child_info']['age']}} Years</td>
                                            <td>{{$data['child_info']['gender']}}</td>
                                            <td>{{$therapist->submission_date}}</td>
                                            <td><a href="{{route('kids.result.id',$therapist->id)}}">View </a></td>
