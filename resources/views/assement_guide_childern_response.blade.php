        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Kids Assement Report</li>
                </ul>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            @forelse ($listofanswers as $key => $therapist)
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                        <h6 class="mb-0"><i class="fas fa-user-circle text-primary"></i> Parent: {{ $therapist->users->name }}</h6>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p><strong>👦 Child Name:</strong> {{ $data['child_info']['name'] }}</p>
                                <p><strong>📅 Age:</strong> {{ $data['child_info']['age'] }} Years</p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>⚧ Gender:</strong> {{ $data['child_info']['gender'] }}</p>
                            </div>
                        </div>
                                    ...
                                    <div id="collapse{{ $loop->index }}" class="accordion-collapse collapse">
                                        <div class="accordion-body">
                                            @foreach ($questions as $question)
                                                ...
                                                <p><strong>A:</strong> <span class="badge 
                                                    @if($question['answer'] == 'Yes') bg-success 
                                                    @elseif($question['answer'] == 'No') bg-danger 
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item"><strong>41-50:</strong> ✅ Development appears typical for age. No significant concerns.</li>
                        <li class="list-group-item"><strong>31-40:</strong> ⚠️ Some areas of concern. Consider monitoring and engaging in activities to boost skills.</li>
                        <li class="list-group-item"><strong>21-30:</strong> ❗ Potential developmental delays. A professional evaluation is recommended.</li>
                        <li class="list-group-item"><strong>0-20:</strong> 🚨 High likelihood of developmental concerns. Immediate professional consultation is advised.</li>
                    </ul>
                </div>
            </div>
        </div>
