                ...
                <div class="col-xxl-12">
                    <div class="card stretch stretch-full">
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                ...
                                                <div class="action-buttons">
                                                    <a href="{{ route('get_partient_appointment', $user->id) }}" class="btn btn-primary btn-sm">View</a>
                                                </div>    
                        ...
                        <div class="card-footer">
                            {{ $users_details->links('pagination::bootstrap-4') }}
