    ...
    <div class="header-wrapper">
        ...
        <div class="header-left d-flex align-items-center gap-4">
            ...
            <div class="nxl-lavel-mega-menu-toggle d-flex d-lg-none">
                <a href="javascript:void(0);" id="nxl-lavel-mega-menu-open" style="display: none">
                    <i class="feather-align-left"></i>
                </a>
            </div>
            ...
            <div class="nxl-drp-link nxl-lavel-mega-menu">
                ...
                <div class="nxl-lavel-mega-menu-wrapper d-flex gap-3" style="display:none !important">
        ...
        <div class="header-right ms-auto">
            <div class="d-flex align-items-center">
                <div class="dropdown nxl-h-item nxl-header-search" style="display:none !important">
                ...
                <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex" style="display:none !important">
                ...
                <div class="nxl-h-item dark-light-theme" style="display:none !important">
                ...
                <div class="dropdown nxl-h-item" style="display:none !important">
                ...
                <div class="dropdown nxl-h-item">
                    <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                        <img src="{{asset('assets/icon/avatar.jpg')}}" alt="user-image" class="img-fluid user-avtar me-0" />
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                <img src="{{asset('assets/icon/avatar.jpg')}}" alt="user-image" class="img-fluid user-avtar" />
                                <div>
                                    <h6 class="text-dark mb-0">{{ Auth::check() ? Auth::user()->name : "No Data"  }} <span class="badge bg-soft-success text-success ms-1">@if(Auth::check() && Auth::user()->user_type==2) Admin @elseif(Auth::check() && Auth::user()->user_type==3) Therapist  @endif</span></h6>
                                    <span class="fs-12 fw-medium text-muted"><a href="#" class="__cf_email__" data-cfemail="c1a0ada4b9efa5a4adada081aeb4b5adaeaeaaefa2aeac"> {{Auth::check() ? Auth::user()->email : "No Data" }} </a></span>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="{{route('getmydetails')}}" class="dropdown-item">
