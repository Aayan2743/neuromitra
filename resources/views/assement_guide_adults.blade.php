        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Question For Adults Assesment </li>
                </ul>
            </div>
                ...
                <div class="col-xxl-12">
                    <div class="card stretch stretch-full">
                        <div class="card-header">
                            <h5 class="card-title">Add Question For Adults Assesment</h5>
                        ...
                        <div class="card-body custom-card-action p-0">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('create_assesement_for_adults.store') }}">
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <select class="form-select @error('questionType') is-invalid @enderror" aria-label="Default select example" id="questionType" name="questionType">
                                                ...
                                                <option value="Personal Growth and Self-Awareness" {{ old('questionType') == 'Personal Growth and Self-Awareness' ? 'selected' : '' }}>Personal Growth and Self-Awareness</option>
                                                <option value="Emotional Well-being and Resilience" {{ old('questionType') == 'Emotional Well-being and Resilience' ? 'selected' : '' }}>Emotional Well-being and Resilience</option>
                                                <option value="Relationships and Communication" {{ old('questionType') == 'Relationships and Communication' ? 'selected' : '' }}>Relationships and Communication</option>
                                                <option value="Cognitive and Intellectual Development" {{ old('questionType') == 'Cognitive and Intellectual Development' ? 'selected' : '' }}>Cognitive and Intellectual Development</option>
                                                <option value="Life Satisfaction and Purpose" {{ old('questionType') == 'Life Satisfaction and Purpose' ? 'selected' : '' }}>Life Satisfaction and Purpose</option>
                                            </select>
